...
fn cornell_box(){
    ...
    let lights = Arc::new(Quad::new(Vec3::new(343.0,554.0,332.0),Vec3::new(-130.0,0.0,0.0),Vec3::new(0.0,0.0,-105.0),empty_material));
...
fn cornell_box2(){
    ...
    let mut cam: Camera = Camera::new(1.0,600,500,50,40.0,Vec3::new(278.0,278.0,-800.0),
    Vec3::new(278.0,278.0,0.0), Vec3::new(0.0,1.0,0.0), 0.0, 10.0, Vec3::enew());
